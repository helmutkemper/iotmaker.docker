...
// ContainerCreateExposePortsAutomaticallyAndStart (English): Creates a container,
// automatically exposes the ports listed in the image and start then
...
//
//
// ContainerCreateExposePortsAutomaticallyAndStart (Português): Cria um container,
// automaticamente expões as portas listas na imagem e o inicia
...
func (el *DockerSystem) ContainerCreateExposePortsAutomaticallyAndStart(
	...
	containerID, err = el.ContainerCreateAndExposePortsAutomatically(
		imageName,
		containerName,
		restartPolicy,
		mountVolumes,
