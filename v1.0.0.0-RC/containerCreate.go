...
// ContainerCreate (English): Creates a container and automatically exposes the ports
// listed in the image
...
//
//
// ContainerCreate (Português): Cria um container e automaticamente expões as portas
// listas na imagem
