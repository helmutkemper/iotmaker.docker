...
// ContainerCreateAndExposePortsAutomatically (English): Creates a container and
// automatically exposes the ports listed in the image
...
//
//
// ContainerCreateAndExposePortsAutomatically (Português): Cria um container e
// automaticamente expões as portas listas na imagem
